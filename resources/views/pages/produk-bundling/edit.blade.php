                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form action="#" id="form_simpan" method="POST">
                            ...
                            <input type="hidden" name="id" class="form-control" value="{{ $bundling->id }}">


                            <div class="form-group">
                                <label for="">Kode:</label>
                                <input type="text" name="kode" class="form-control" placeholder="Masukan kode" value="{{ $bundling->kode }}">
                            ...
                            <div class="form-group">
                                <label for="">Sku:</label>
                                <input type="text" name="sku" class="form-control" placeholder="Masukan sku" value="{{ $bundling->sku }}">
                                <span class="text-danger error-text sku_error" style="font-size: 12px;"></span>
                            </div>

                            <div class="form-group">
                                <label for="">Nama:</label>
                                <input type="text" name="nama" class="form-control" placeholder="Masukan nama" value="{{ $bundling->nama }}">
    ...
    <script>
        $(document).ready(function() {
            $("#form_simpan").submit(function(e) {
                ...
                $.ajax({
                    url: '{{ route('produk_bundling.update') }}',
                    method: 'post',
                    data: formData,
                    cache: false,
                    processData: false,
